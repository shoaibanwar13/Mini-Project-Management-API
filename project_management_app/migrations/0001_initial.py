# Generated by Django 5.1.3 on 2025-02-06 14:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Project_Tasks', to='project_management_app.project')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.AddField(
            model_name='project',
            name='creator',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Project_Assigner', to='project_management_app.user'),
        ),
    ]
